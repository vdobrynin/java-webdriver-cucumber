...
public class MarketStepDefs {
  ...
  public void iFillOutOptionalFields() {
    ...
    getDriver().findElement(By.xpath("//select[@class='ui-datepicker-year']/option[@value='1975']")).click();
    getDriver().findElement(By.xpath("//input[@id='dateOfBirth']")).sendKeys("10/03/1975");
    getDriver().findElement(By.xpath("//select[@name='countryOfOrigin']/option[contains(text(),'Monaco')]")).click();
    getDriver().findElement(By.xpath("//*[@name='gender'][@value='male']")).click();
    getDriver().findElement(By.xpath("//input[@type='checkbox'][@name='allowedToContact']")).isSelected();
    getDriver().findElement(By.xpath("//textarea[@id='address']")).sendKeys("4970 El Camino Real, Los Altos, CA 94022");
    getDriver().findElement(By.xpath("//select[@name='carMake']//option[contains(text(),'BMW')]")).click();
    WebElement privacyPolicy = getDriver().findElement(By.xpath("//*[@name='agreedToPrivacyPolicy']"));
  ...
  public void iVerifyEmailFieldBehavior() {
    ...
    getDriver().findElement(By.xpath("//input[@name='email']")).sendKeys("slavaskryabin.com");
    getDriver().findElement(By.xpath("//button[@id='formSubmit']")).click();
...
//    emailField.clear(); //emailField.sendKeys(Keys.BACK_SPACE);
  ...
  public void iAgreement(String clickArg) {
    WebElement thirdPartyButton = getDriver().findElement(By.xpath("//*[@id='thirdPartyButton']"));
  ...
  public void iVerifyThatFieldsValuesRecordedCorrectly() {
    ...
    String resultText = getDriver().findElement(By.xpath("//div[@class='well form-container container-fluid']")).getText();
  ...
  public void iInputAsContact(String firstName, String lastName) {
    getDriver().switchTo().frame("additionalInfo");               // --> switch to "iframe" & it has a name "additionalInfo"
    getDriver().findElement(By.xpath("//input[@id='contactPersonName']")).sendKeys(firstName + " " + lastName);
    getDriver().findElement(By.xpath("//input[@id='contactPersonPhone']")).sendKeys("1234567890");
    getDriver().switchTo().defaultContent();   // --> switch back to defaultContent (original page)
  }
